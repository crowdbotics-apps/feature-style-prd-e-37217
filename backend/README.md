...
## Project Structure
    ...
    ├── feature_style_prd_e_37217  # Django project configurations
...
1. Clone this repo and `cd feature_style_prd_e_37217`
...
2. Clone this repo and `cd feature_style_prd_e_37217`
